...
app.get('/api/stats', asyncHandler(async (_req: Request, res: Response) => {
 ...
 */
app.get('/api/monitoring/rate-limits', asyncHandler(async (_req: Request, res: Response) => {
 ...
 */
app.get('/api/monitoring/cache', asyncHandler(async (_req: Request, res: Response) => {
...
app.get('/api/agents', asyncHandler(async (req: Request, res: Response) => {
  ...
  const enrichedAgents = await Promise.allSettled(
    ...
    .filter((agent): agent is typeof paginatedAgents[number] & { balance: number } => agent !== null)
  );
...
app.post('/api/agents', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
...
app.post('/api/agents/:id/start', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const orchestrator = getOrchestrator();
...
app.post('/api/agents/:id/stop', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const orchestrator = getOrchestrator();
 ...
 */
app.post('/api/agents/:id/pause', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const orchestrator = getOrchestrator();
 ...
 */
app.post('/api/agents/:id/resume', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const orchestrator = getOrchestrator();
...
app.patch('/api/agents/:id/config', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
...
app.get('/api/strategies', requireAdminAuth, asyncHandler(async (_req: Request, res: Response) => {
...
app.get('/api/strategies/:name', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const registry = getStrategyRegistry();
...
app.get('/api/transactions', asyncHandler(async (req: Request, res: Response) => {
  const orchestrator = getOrchestrator();
...
app.get('/api/events', asyncHandler(async (req: Request, res: Response) => {
 ...
 */
app.post('/api/byoa/register', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
 ...
 */
app.post('/api/byoa/verify/challenge-generate', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
 ...
 */
app.post('/api/byoa/verify/challenge-submit', asyncHandler(async (req: Request, res: Response) => {
  const { agentId, challengeResponse } = req.body;
  if (!agentId || typeof agentId !== 'string' || !challengeResponse || typeof challengeResponse !== 'string') {
    sendError(
      res,
 ...
 */
app.post('/api/byoa/intents', asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await router.submitIntent(bearerValidation.token, validation.data as ExternalIntent);
  ...
  const statusCode = intentResult.status === 'executed' ? HTTP_STATUS.OK : HTTP_STATUS.UNPROCESSABLE_ENTITY;
 ...
 */
app.get('/api/byoa/agents', asyncHandler(async (_req: Request, res: Response) => {
  const registry = getAgentRegistry();
  const client = getSolanaClient();
  const walletManager = getWalletManager();
  ...
  const enriched = await Promise.allSettled(
    ...
    results.map((result) => {
      ...
      logger.warn('Failed to enrich BYOA agent with balance', { reason: String(result.reason) });
      return null;
    })
 ...
 */
app.get('/api/byoa/agents/:id', asyncHandler(async (req: Request, res: Response) => {
  const registry = getAgentRegistry();
  const router = getIntentRouter();
  const client = getSolanaClient();
  const walletManager = getWalletManager();
 ...
 */
app.get('/api/byoa/agents/:id/intents', asyncHandler(async (req: Request, res: Response) => {
  const router = getIntentRouter();
 ...
 */
app.post('/api/byoa/agents/:id/deactivate', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const registry = getAgentRegistry();
 ...
 * Admin action â€” no bearer token required (dashboard use).
 */
app.post('/api/byoa/agents/:id/activate', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const registry = getAgentRegistry();
 ...
 * Admin action â€” no bearer token required (dashboard use).
 */
app.post('/api/byoa/agents/:id/revoke', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const registry = getAgentRegistry();
 ...
 */
app.post('/api/byoa/agents/:id/rotate-token', requireAdminAuth, asyncHandler(async (req: Request, res: Response) => {
  const registry = getAgentRegistry();
 ...
 */
app.get('/api/byoa/intents', asyncHandler(async (req: Request, res: Response) => {
  const router = getIntentRouter();
  const limit = Math.min(parseInt(req.query['limit'] as string) || 100, 500);
 ...
 */
app.get('/api/intents', asyncHandler(async (req: Request, res: Response) => {
  const router = getIntentRouter();
